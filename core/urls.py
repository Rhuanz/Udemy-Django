...
from .views import cadastroendereco, cadastroproprietario, atualizarimovel, cadastrovisita, vendas, venda, cadastrovenda
urlpatterns = [
    ...
    path('vendas/CadastroVenda', cadastrovenda, name='cadastrovenda'),
]